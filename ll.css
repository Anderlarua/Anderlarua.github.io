body {background: url("http://wx3.sinaimg.cn/large/b9190547gy1fu0cyn7zfzj238o1t34qp.jpg") fixed;background-repeat: no-repeat;background-size: cover;color: #000;font-family:CHILLER;font-size : 2em;}
